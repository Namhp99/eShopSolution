    ...
    public static class ModelBuiderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTitle", Value = "This is home page of eShopLolution" },
                new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of eShopLolution" },
                new AppConfig() { Key = "HomeDecription", Value = "This is decription of eShopLolution" }
                );
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                    ...
                    new CategoryTranslation() { Id = 4, CategoryId = 2, Name = "Women Shirt", LanguageId = "en-US", SeoAlias = "men-shirt", SeoDescription = "The shirt products for women", SeoTitle = "The shirt products for wonmen" }
